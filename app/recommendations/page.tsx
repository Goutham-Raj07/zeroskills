...
const mockRecommendations = [
  ...
  },
  {
    ...
    examDate: "Sessions across Jan–Apr (as per NTA)",
    applicationDeadline: "As notified by NTA",
    difficulty: "High",
    colleges: ["NITs", "IIITs", "GFTIs", "Eligibility for JEE Advanced"],
    subjects: ["Physics", "Chemistry", "Mathematics"],
    pattern: "Computer Based Test",
    duration: "3 hours",
    prepUrl: "https://jeemain.nta.nic.in/",
  },
  {
    id: "data-science",
    title: "Data Science",
...
const mockExams = [
  ...
  },
  {
    ...
    examDate: "May (as per NTA schedule)",
    applicationDeadline: "As notified by NTA",
    difficulty: "High",
    colleges: ["MBBS/BDS Colleges via MCC/State Counseling"],
    subjects: ["Physics", "Chemistry", "Biology"],
    pattern: "Pen & Paper (OMR)",
    duration: "200 minutes",
    prepUrl: "https://neet.nta.nic.in/",
  },
  {
    id: "clat-ug",
    name: "CLAT (UG)",
    type: "Law Entrance",
    eligibility: "12th pass (min % as notified)",
    examDate: "December (as per Consortium)",
    applicationDeadline: "As per CLAT calendar",
    difficulty: "High",
    colleges: ["NLUs and participating universities"],
    subjects: ["English", "Logical Reasoning", "Legal Reasoning", "GK/CA", "Quant"],
    pattern: "Offline (MCQ)",
    duration: "120 minutes",
    prepUrl: "https://consortiumofnlus.ac.in/",
  },
  {
    id: "cuet-ug",
    name: "CUET (UG)",
    ...
    examDate: "May–June (as per NTA)",
    applicationDeadline: "As notified by NTA",
    difficulty: "Medium",
    colleges: ["Central Universities & participating institutions"],
    subjects: ["Language", "Domain Subjects", "General Test"],
    pattern: "Computer Based Test",
    duration: "Varies by slots",
    prepUrl: "https://cuet.nta.nic.in/",
  },
  {
    id: "nda",
    name: "NDA",
    type: "Government Jobs",
    eligibility: "12th pass (age limits per UPSC)",
    examDate: "April & September (as per UPSC)",
    applicationDeadline: "As per UPSC calendar",
    difficulty: "High",
    colleges: ["National Defence Academy", "Naval Academy"],
    subjects: ["Mathematics", "General Ability Test"],
    pattern: "Written + SSB",
    duration: "2 x 150 minutes",
    prepUrl: "https://www.upsc.gov.in/",
  },
  {
    id: "ssc-chsl",
    name: "SSC CHSL",
    type: "Government Jobs",
    eligibility: "12th pass",
    examDate: "Tier-I mid-year (as per SSC)",
    applicationDeadline: "As per SSC calendar",
    difficulty: "Medium",
    colleges: ["Central Govt. Clerical Cadres"],
    subjects: ["English", "Quant", "Reasoning", "General Awareness"],
    pattern: "Tier-I (CBT), Tier-II/Skill Tests",
    duration: "Tier-I ~60 minutes",
    prepUrl: "https://ssc.nic.in/",
  },
  {
    id: "rrb",
    ...
    examDate: "As per RRB notifications",
    applicationDeadline: "As per RRB notifications",
    difficulty: "Medium",
    colleges: ["Indian Railways (various boards)"],
    subjects: ["Math", "Reasoning", "GA", "Technical (as applicable)"],
    pattern: "CBT + subsequent stages",
    duration: "Varies by post",
    prepUrl: "https://www.rrbcdg.gov.in/",
  },
]
