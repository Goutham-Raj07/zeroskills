...
const assessmentSteps = [
  ...
  },
  {
    ...
    description: "Answer 5 quick questions about interests, skills, goals, learning, values",
    icon: Brain,
  ...
  },
  {
    ...
    description: "Answer 10-15 tailored questions generated by AI",
    icon: Code,
    component: AIQuiz,
  },
]
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              {currentStep === 0 ? (
                ...
                assessmentSteps[currentStep].id === "profile-questions" ? (
                  <ProfileQuestions
                    onComplete={(answers) => {
                      setProfileAnswers(answers)
                      handleStepComplete(assessmentSteps[currentStep].id)
                    }}
                  />
                ) : assessmentSteps[currentStep].id === "ai-quiz" ? (
                  <AIQuiz
                    answers={{
                      favorite_subjects: profileAnswers["favorite_subjects"],
                      skills: profileAnswers["skills"],
                      aspirations: profileAnswers["aspirations"],
                      learning_style: profileAnswers["learning_style"],
                      values: profileAnswers["values"],
                    }}
                    onComplete={() => handleStepComplete(assessmentSteps[currentStep].id)}
                  />
                ) : (
